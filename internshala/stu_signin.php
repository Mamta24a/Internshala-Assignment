...
if(isset($_POST['signup'])) {
    ...
    $check_email = $conn->query("SELECT email FROM stu_user WHERE email='$email'");
    $count=$check_email->num_rows;
    
    if ($count==0) {
        
        $query = "INSERT INTO stu_user(f_name,l_name,email,password,temp_pass) VALUES('$f_name','$l_name','$email','$hashed_password' , '$password')";
...
<div id="navbar-container" style="line-height: 80px;">
                ...
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown dropdown-hover">
								...
								<div class="dropdown-content">
                                     ...
                                     <hr style="margin:0px">
                                     <a href="emp_signin.php" rel="modal" >Register Emp</a>
                                </div>
	...
	<div class="stu_reg_bg">
		<form class="stu_reg_box" method="post" >
	       <h2 style="color:red">Student Registration</h2><br>
		    <?php
        if (isset($msg)) {
            echo $msg;
        }
        ?>
		   ...
		   <p align="center">Already registered? <a href="stu_login.php">Login</a></p>
	    </form>
	</div>
