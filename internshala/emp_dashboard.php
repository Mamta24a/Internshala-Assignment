...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Post a new Internship</a></li>
    <li><a data-toggle="tab" href="#menu1">View Internship</a></li>
    <li><a data-toggle="tab" href="#menu2">Application Recieved</a></li>
  </ul>
...
<div class="new_post"> 	
	...
	<div class="container" style="padding:3% 8% 0% 8%">
	 ...
	 <span style="background:#888;color:white;padding:3px;margin-right:3px"><?php echo "$row[part_time]";?></span>
	  <span style="background:#888;color:white;padding:3px"><?php echo "$row[primary_profile]";?></span>
		...
		<?php
	        if(mysqli_num_rows($query1)==0){ echo'<p style="color:gray"><br>You have not posted any internship yet......<br><br></p>';}
		?>
    ...
    $query2 =$conn->query("select * from app_recieved where emp_email = '".$_SESSION['userSession']."' ");	
     while($row = $query2->fetch_array())
        { 
	?>
	  <div class="new_post" style="margin:2% 5%; padding:2% 5%; color:#777;">
      <p><label>Work Profile: </label><?php echo " $row[profile]";?>
	...
	<?php } ?>
		...
		<?php
	        if(mysqli_num_rows($query2)==0){ echo'<p style="color:gray"><br>You have not Recieved any Application yet......<br><br></p>';}
		?>
	</div>
   </div>
   
   
   <p class="greyhead" >Note: Please don't use this(') symbol in textboxes...</p>
</div>
